...
public:
	ShellBullet()
	{
		static SDL_Texture* texture = ResourcesManager::instance()
		...
		animation.set_frame_data(texture, 2, 1, idx_list);
	...
	void on_render(SDL_Renderer* renderer) override
	{
		...
		else
		{
			...
			point.x = (int)(position.x - 96 / 2);  // 找到左上角坐标
