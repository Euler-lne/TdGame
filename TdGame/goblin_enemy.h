...
public:
	GoblinEnemy()
	{
		...
		static SDL_Texture* tex_normal = texture_pool.find(ResID::Tex_Goblin)->second;
		static SDL_Texture* tex_sketch = texture_pool.find(ResID::Tex_GoblinSketch)->second;
		static ConfigManager::EnemyTemplate& enemy_template = ConfigManager::instance()->goblin_template;
